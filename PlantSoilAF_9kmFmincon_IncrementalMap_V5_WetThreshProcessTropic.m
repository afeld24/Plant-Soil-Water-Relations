...
% IncAfDry = IncAf./0.11;
% load('IncrementMedian_HalfDeg_4Inc_WetEnd_NullRemove_SMThreshEst_Globe')
load('IncrementMedian_HalfDeg_4Inc_WetEnd_NullRemove_SMThreshEstNoNull')
IncMedianWet = IncMedian;
IncMedianWet(IncCount<50)=NaN;
% load('IncrementMedian_HalfDeg_4Inc_DryEnd_NullRemove_SMThreshEst_Globe')
load('IncrementMedian_HalfDeg_4Inc_DryEnd_NullRemove_SMThreshEstNoNull')
IncMedianWet(IncCount<50)=NaN;
% PixCount(DryDownCount<10)=NaN;
...
IncMedianWetAf = IncMedianWet(rowAf,colAf);
IncMedianWetSA = IncMedianWet(rowSA,colSA);
IncMedianWetAu = IncMedianWet(rowAu,colAu);
...
IncMedianWetAllAf = IncMedianWet(rowAf,colAf);
IncMedianWetAllSA = IncMedianWet(rowSA,colSA);
IncMedianWetAllAu = IncMedianWet(rowAu,colAu);
...
pos = get(c,'Position')
set(gca,'color',[0.7 0.7 0.7])
c.Label.Position = [pos(1)+2.8 pos(2)-0.5];
shading flat
set(gca,'yticklabel',{})
set(gca,'xticklabel',{})
hold on
...
% annotation('textbox',[0.62+((ia-1)/100)*6.8 0.51 0.1 0.1],'String',aNum,'fontsize',15,'Fontname','arial','FontWeight','bold','EdgeColor','none')
...
% annotation('textbox',[0.295+((ia-1)/100)*8.05 0.19 0.1 0.1],'String',aNum,'fontsize',15,'Fontname','arial','FontWeight','bold','EdgeColor','none')
...
% print('Fig4WetResponse','-djpeg','-r300')
% print('Fig4WetResponse_100','-djpeg','-r100')
print('Fig4','-depsc','-r1200')